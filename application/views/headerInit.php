...
<div id="wrapper">
    <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;border-color: transparent;">
            
        </nav>
    <div id="page-wrapper" style="min-height: 253px; background-color: transparent; border-color: transparent;margin: auto!important;position: relative;">
